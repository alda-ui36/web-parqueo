...
export const tipoVehiculoService = {
  async create(
    request: TipoVehiculoRequest
  ): Promise<ApiResponse<TipoVehiculoResponse>> {
  ...
  async getById(id: number): Promise<ApiResponse<TipoVehiculoResponse>> {
  ...
  ): Promise<ApiResponse<TipoVehiculoPageResponse>> {
