...
import { registroEntradaSchema, type RegistroEntradaSchema } from "@/schemas/registro-entrada.schema";
        ...
        if (dni && dni.length === 8) {
            try {
                ...
                if (res.data) {
                    ...
                    setTimeout(() => {
                        form.trigger(["dni", "nombres", "apePaterno", "correo", "apeMaterno"]);
                    }, 100);
        ...
        try {
            ...
            if (res.data) {
                ...
                if (typeof res.data.idTipoVehiculo === "number") {
                    ...
                    const tipo = tiposVehiculo.find(tv => tv.id === res.data.idTipoVehiculo);
