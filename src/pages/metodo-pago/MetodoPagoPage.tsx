...
export const MetodoPagoPage = () => {
    ...
    const actions = (metodo: any) => (
        <div className="flex gap-2">
            ...
            <Button variant="outline" size="sm" onClick={() => toggleStatus(metodo.id)}>
                <Power className={`h-4 w-4 ${metodo.estado ? "text-red-500" : "text-green-500"}`} />
            </Button>
        </div>
    );
    ...
    return (
        <div className="container mx-auto py-6">
            <h1 className="text-2xl font-bold text-gray-900">Gestión de Métodos de Pago</h1>
            <p className="text-gray-600 mt-2">Administra los métodos de pago del sistema</p>
            ...
            <DataTable
                ...
                pagination={{
                    ...
                    onPageChange: (p) => loadMetodos(p, pagination.pageSize, undefined, estadoFilter),
