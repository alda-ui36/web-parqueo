...
import type { EspacioSchema } from "@/schemas/espacios.schema";
...
export const EspacioFormDialog = ({
  ...
  const espaciosDisponibles = form.watch("zonaId")
    ? getEspaciosDisponibles(form.watch("zonaId"))
    : null;
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>
            {editingEspacio
              ? "Edita los datos del espacio."
              : "Ingresa los datos del nuevo espacio."}
          </DialogDescription>
        </DialogHeader>
                ...
                <FormItem>
                  ...
                  {zonaSeleccionada && (
                    <div className="text-xs text-gray-500 mt-1">
                      ...
                      / {zonaSeleccionada.totalEspacios}
                    </div>
                  )}
                  <FormMessage />
                </FormItem>
